...
namespace Microsoft.IdentityModel.Xml
{
    ...
    public sealed class EnvelopedSignatureReader : DelegatingXmlDictionaryReader
    {
        ...
        public override bool Read()
        {
            ...
            if (   result 
                && _signedXml == null
                && InnerReader.IsLocalName(XD.XmlSignatureDictionary.Signature)
                && InnerReader.IsNamespaceUri(XD.XmlSignatureDictionary.Namespace))
            {
                ReadSignature();
            }
        ...
        void ReadSignature()
        {
            _signedXml = new SignedXml(new WifSignedInfo(_dictionaryManager), _dictionaryManager);
