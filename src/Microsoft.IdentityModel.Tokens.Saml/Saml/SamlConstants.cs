...
namespace Microsoft.IdentityModel.Tokens.Saml
{
    ...
    {
        static public string Assertion = "Assertion";
        static public string EncryptedAssertion = "EncryptedAssertion";
        static public string Saml11Namespace = "urn:oasis:names:tc:SAML:1.0:assertion";
        static public string Saml2Namespace = "urn:oasis:names:tc:SAML:2.0:assertion";
